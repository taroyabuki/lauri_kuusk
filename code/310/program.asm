; 310 Mars 3 landing/shooter flag edition for MSX2 / Pasmo
;
...
; positions: one X unit is two pixels. The player keeps 260's target pursuit
; control and uses Estonia flag colors: blue, black, and white.
